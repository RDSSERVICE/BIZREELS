...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: '#D99A3D', fontSize: 11 },
  refreshBtn: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  liveStatusText: { color: '#059669', fontSize: 11, fontWeight: FontWeight.bold },

  filterRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 4 },
  timeframeLabel: { color: '#64748B', fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 0.5 },
  rangePillRow: { gap: 6 },
  rangePill: {
  ...
  rangePillActive: { backgroundColor: '#241B15', borderColor: '#D99A3D' },
  rangePillText: { color: '#64748B', fontSize: 11, fontWeight: FontWeight.bold },
  rangePillTextActive: { color: '#D99A3D' },
  ...
  simulateBtnText: { color: '#D99A3D', fontSize: 11, fontWeight: FontWeight.bold },

  sectionHeaderTitle: { color: '#241B15', fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1 },
  ...
  kpiLabel: { color: '#64748B', fontSize: 9, fontWeight: FontWeight.bold, letterSpacing: 0.5, flex: 1 },
  kpiIconBox: { width: 28, height: 28, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  kpiValue: { color: '#0F172A', fontSize: FontSize.base, fontWeight: '900', marginTop: 4 },
  kpiDesc: { color: '#64748B', fontSize: 10 },
  ...
  chartTitle: { color: '#0F172A', fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 0.5 },
  ...
  metricTabActive: { backgroundColor: '#241B15', borderColor: '#D99A3D' },
  metricTabText: { color: '#64748B', fontSize: 10, fontWeight: FontWeight.bold },
  metricTabTextActive: { color: '#D99A3D' },

  chartLoadingBox: { height: 140, alignItems: 'center', justifyContent: 'center', gap: 8 },
  chartLoadingText: { color: '#64748B', fontSize: 11 },
  ...
  barValueText: { color: '#D99A3D', fontSize: 8, fontWeight: 'bold', marginBottom: 2 },
  barTrack: { width: '80%', height: '70%', backgroundColor: '#F1F5F9', borderRadius: 4, justifyContent: 'flex-end', overflow: 'hidden' },
  barFill: { width: '100%', backgroundColor: '#D99A3D', borderRadius: 4 },
  barDateText: { color: '#64748B', fontSize: 8, marginTop: 4 },

  emptyChartBox: { height: 120, alignItems: 'center', justifyContent: 'center', gap: 6 },
  emptyChartText: { color: '#64748B', fontSize: 11, fontWeight: FontWeight.medium },
  ...
  funnelTitle: { color: '#0F172A', fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 0.5 },
  funnelSteps: { gap: Spacing.two },
  stepRow: { gap: 4 },
  stepHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  stepName: { color: '#64748B', fontSize: 11, fontWeight: FontWeight.medium },
  stepCount: { color: '#0F172A', fontSize: 11, fontWeight: FontWeight.bold },
  stepBarBg: { height: 8, borderRadius: 4, backgroundColor: '#F1F5F9', overflow: 'hidden' },
  ...
  ratingTitle: { color: '#64748B', fontSize: 9, fontWeight: FontWeight.bold, letterSpacing: 0.5 },
  ratingScoreRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ratingLabel: { color: '#0F172A', fontSize: 11, fontWeight: FontWeight.medium },
  ratingValue: { color: '#D99A3D', fontSize: 12, fontWeight: FontWeight.bold },
  ...
  breakdownTitle: { color: '#0F172A', fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 0.5 },
  breakdownSub: { color: '#64748B', fontSize: 10 },
  ...
  searchInput: { flex: 1, height: 36, color: '#0F172A', fontSize: 11 },
  ...
  sortPillActive: { backgroundColor: '#241B15', borderColor: '#D99A3D' },
  sortPillText: { color: '#64748B', fontSize: 10, fontWeight: FontWeight.bold },
  sortPillTextActive: { color: '#D99A3D' },

  listingsLoadingBox: { height: 100, alignItems: 'center', justifyContent: 'center', gap: 6 },
  listingsLoadingText: { color: '#64748B', fontSize: 11 },
  ...
  listingTypeBadgeText: { color: '#D99A3D', fontSize: 8, fontWeight: FontWeight.bold },
  listingPriceText: { color: '#059669', fontSize: 11, fontWeight: FontWeight.bold },
  listingItemTitle: { color: '#0F172A', fontSize: 12, fontWeight: FontWeight.bold },
  ...
  metricPillVal: { color: '#0F172A', fontSize: 10, fontWeight: FontWeight.bold },
  ...
  boostRoiBtnText: { color: '#D99A3D', fontSize: 10, fontWeight: FontWeight.bold },
  organicTag: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  organicTagText: { color: '#64748B', fontSize: 10, fontStyle: 'italic' },

  emptyListingsBox: { height: 100, alignItems: 'center', justifyContent: 'center', gap: 6 },
  emptyListingsText: { color: '#64748B', fontSize: 11, fontWeight: FontWeight.medium },
  ...
  modalTitle: { color: '#0F172A', fontSize: 13, fontWeight: FontWeight.bold },
  modalSubTitle: { color: '#D99A3D', fontSize: 11, fontWeight: FontWeight.bold },

  modalLoadingBox: { height: 150, alignItems: 'center', justifyContent: 'center', gap: 8 },
  modalLoadingText: { color: '#64748B', fontSize: 11 },
  ...
  roiDateLabel: { color: '#64748B', fontSize: 10 },
  roiDateValue: { color: '#0F172A', fontSize: 10, fontWeight: FontWeight.bold },

  liftMetricsHeader: { color: '#64748B', fontSize: 9, fontWeight: FontWeight.bold, letterSpacing: 0.5, marginBottom: 4 },
  liftMetricRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  liftMetricName: { color: '#0F172A', fontSize: 11, fontWeight: FontWeight.medium },
  liftMetricBaselineBox: { alignItems: 'center', width: 60 },
  liftMetricMicroTag: { color: '#64748B', fontSize: 7, fontWeight: FontWeight.bold },
  liftMetricVal: { color: '#0F172A', fontSize: 11, fontWeight: FontWeight.bold },
  ...
  liftBadgePos: { backgroundColor: '#ECFDF5', color: '#059669' },
  liftBadgeNeutral: { backgroundColor: '#F1F5F9', color: '#64748B' },
  ...
  infoBoxText: { color: '#64748B', fontSize: 10, flex: 1, lineHeight: 14 },
  ...
  modalCloseFooterBtnText: { color: '#D99A3D', fontSize: 12, fontWeight: FontWeight.bold },
});
