  ...
  const handleGenerateAiSpecs = async () => {
    ...
    try {
      ...
      if (res?.data?.specifications || res?.data?.data?.specifications) {
        setDescription(res.data.specifications || res.data.data.specifications);
        Alert.alert('✨ AI Specs Generated!', 'Professional technical specifications generated by AI.');
      } else {
