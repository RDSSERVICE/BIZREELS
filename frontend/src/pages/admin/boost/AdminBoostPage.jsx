    ...
    <div className="max-w-7xl mx-auto flex flex-col gap-6 animate-fade-in">
      ...
      >
        <button
          ...
          className="px-4 py-2 gradient-brand text-white rounded-xl text-xs font-bold hover:opacity-90 transition-all flex items-center gap-1.5 shadow-premium cursor-pointer"
        >
        ...
        <AdminDataTable
          ...
          actions={(row) => (
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-brand-purple/10 text-text-tertiary hover:text-brand-purple transition-all cursor-pointer"
              title="Edit Plan"
            >
      ...
      <AdminModal isOpen={showModal} onClose={() => setShowModal(false)} title={editPlan ? 'Edit Boost Plan' : 'Create Boost Plan'}>
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full py-2.5 gradient-brand text-white rounded-xl text-xs font-bold hover:opacity-90 transition-all cursor-pointer"
          >
