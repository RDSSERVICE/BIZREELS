                  ...
                  <div>
                    <div className="flex justify-between items-center border-b border-border/50 pb-2 mb-2">
                      <div className="flex items-center gap-1.5">
                        ...
                        {isReel && (
                          <span className="px-1.5 py-0.5 rounded bg-brand-purple/10 text-brand-purple text-[9px] font-black uppercase">Reel</span>
                        )}
                      </div>
                    ...
                    <h4 className="font-bold text-xs text-text-primary truncate">{itemTitle}</h4>
                    <p className="text-[10px] text-text-tertiary mt-0.5">Seller: <span className="font-semibold text-text-secondary">{sellerName}</span></p>

                    {/* Customer Sent Message */}
                    <div className="p-3 bg-surface-secondary/50 rounded-xl border border-border/60 mt-3 space-y-1">
                      <span className="text-[9px] font-bold text-text-tertiary uppercase tracking-wider block">Your Question:</span>
                      <p className="text-[10px] text-text-secondary italic line-clamp-3">"{inq.message}"</p>
                    </div>

                    {/* Vendor's Reply (Highlighted if present) */}
                    {inq.replyMessage ? (
