...
import { FiPlus, FiShoppingBag, FiDollarSign, FiImage, FiX, FiUploadCloud } from 'react-icons/fi';
    ...
    <AdminModal isOpen={isOpen} onClose={onClose} title="Create New Product Listing" maxWidth="max-w-lg">
      <form onSubmit={handleSubmit} className="space-y-4 text-left font-sans">
        ...
        <div className="p-3.5 bg-[#f8f4ec] rounded-2xl border border-[#e3dccb] flex items-start gap-3 shadow-2xs">
          ...
          <div>
            <p className="text-xs font-black text-[#1a1a1a]">Quick Product Creator</p>
