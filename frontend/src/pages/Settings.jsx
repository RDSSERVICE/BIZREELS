              ...
              <div className="flex flex-col gap-4 animate-fade-in">
                ...
                <div className="p-4 border border-error/25 bg-error-light/5 rounded-premium flex flex-col gap-4 mt-2">
                  ...
                  <form onSubmit={handleDeleteAccountSubmit} className="flex flex-col gap-3">
                    <div className="flex flex-col gap-1">
                      <label className="text-xs font-bold text-brand-navy uppercase">Type Password to Confirm</label>
                      <input
                        type="password"
                        placeholder="Enter account password"
                        value={deleteConfirmPassword}
                        onChange={(e) => setDeleteConfirmPassword(e.target.value)}
                        className="w-full px-4 py-2 text-xs border border-border rounded-premium bg-surface/50 text-brand-navy focus:outline-none focus:ring-2 focus:ring-brand-purple/20 focus:border-brand-purple h-10 animate-pulse-slow"
                        required
                      />
                    </div>
                    <div className="flex justify-end">
