# Specialized Domain Flow Reports

This module contains deep-dive architectural investigations and implementation flow reports for complex platform subsystems.
...
| Document | Scope |
|---|---|
| [**CREATOR_REVENUE_ESCROW.md**](./CREATOR_REVENUE_ESCROW.md) | Creator revenue holding, dual-entry escrow ledger architecture, and Razorpay payout batching. |
