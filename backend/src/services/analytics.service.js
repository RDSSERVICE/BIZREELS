...
const overview = async (vendorId, rangeKey = '30d') => {
  ...
  return {
    ...
    kpis: {
      ...
      phoneCalls: interactionCounts.click_to_call || 0,
      callsCount: Math.max(interactionCounts.click_to_call || 0, eventCounts.contact_click || 0),
      whatsappCount: Math.max(interactionCounts.whatsapp_contact || 0, eventCounts.wa_click || 0),
      chatsCount: chatsStarted,
      inquiriesCount: Math.max(inquiriesCount, chatsStarted),
