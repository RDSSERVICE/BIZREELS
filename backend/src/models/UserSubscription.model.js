...
const userSubscriptionSchema = new mongoose.Schema({
  ...
  billing_cycle: { type: String, enum: ['monthly', 'quarterly', 'half_yearly', 'yearly', 'recharge', 'one_time'], default: 'monthly' },
  start_date: { type: Date, required: true },
  expiry_date: { type: Date, required: true },
  auto_renewal: { type: Boolean, default: false },
  status: {
    type: String,
    enum: ['active', 'expired', 'cancelled', 'upgraded', 'downgraded', 'suspended', 'completed_topup'],
    default: 'active',
    index: true,
  },
  // Payment details
